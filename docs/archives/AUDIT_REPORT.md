...
| **Differentiation**      | **2/10**     | "AI Calling" is a commodity. Vapi, Retell, Bland AI do this better as a service. You are wrapping a wrapper. Why should I buy _your_ wrapper?                                       |
...
| **Scalability**          | **7/10**     | Cloud Run + Supabase scales fine. The _tech_ will scale. Your _operations_ won't. Onboarding a clinic without automated calendar sync is manual hell.                               |
...
- **Why they win:** They integrate with the **PMS** (Patient Management System) like Dentrix, Eaglesoft, OpenDental. They read the _actual_ schedule.
...
- **Why you lose:** You are B2B software. Practo is a marketplace. In India, if you don't bring _new patients_, you are barely useful.
- **The Gap:** You save time. They make money. Doctors prefer making money.

### **Vapi.ai / Retell AI (Infrastructure)**

- **Why they win:** They focus _purely_ on voice latency (<800ms).
...
2.  **Receptionist Sabotage**:
    ...
    - She will _let_ it fail. She won't update your dashboard. She will tell the doctor "The AI confused Mrs. Jones."
...
1.  **Build "The Bridge" (PMS Integration)**
    ...
    - _Why:_ Eliminates double-entry. Makes you sticky.
...
2.  **Switch to WebSockets (Streaming Audio)**
    ...
    - _Why:_ Sub-second latency. Feels real. Increases conversion by 50%.

3.  **Staff Co-Pilot Mode (The Trojan Horse)**
    - Don't replace the call. _Listen_ to the receptionist's call and pop up live suggestions/calendar slots.
    - _Why:_ Wins over Mary. Low risk. High trust building.

4.  **The "Revenue Recovery" focus**
    - Stop doing "Confirmations" (boring). Do "Recall".
    - Call patients who haven't been in for 18 months.
    - _Why:_ That is NEW money. Doctors love new money. Confirmations are just admin work.
