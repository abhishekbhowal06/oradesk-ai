...
export function determineIntent(userInput: string, aiIntent?: string): Intent {
    ...
    const confirmPatterns = ['yes', 'yeah', 'yep', 'sure', 'okay', 'ok', 'confirmed', 'i can make it', 'i\'ll be there'];
    ...
    // Check for questions
    if (normalized.includes('?') || normalized.startsWith('what') || normalized.startsWith('when') ||
        normalized.startsWith('where') || normalized.startsWith('how') || normalized.startsWith('who')) {
        return 'question';
    }
...
export function processUserInput(
    ...
    if (context.turnCount > context.maxTurns) {
        ...
        return {
            ...
            responseText: "I want to make sure we get this right. Let me have a staff member help you directly.",
            shouldHangup: true,
            requiresHuman: true,
    ...
    if (!safetyCheck.safe) {
        ...
        return {
            ...
            responseText: "I understand this is urgent. I'm connecting you to our staff right away. Please hold.",
            shouldHangup: true,
            requiresHuman: true,
...
function handleListeningState(
    ...
    switch (intent) {
        case 'confirm':
            ...
            const confirmResponse = aiAnalysis?.responseText ||
        ...
        case 'reschedule':
            ...
            const rescheduleResponse = "I understand you'd like to reschedule. I'll have our scheduling team call you back shortly to find a better time.";
        ...
        case 'cancel':
            ...
            const cancelResponse = "I've noted your cancellation request. A staff member will follow up if needed.";
        ...
        case 'question':
            ...
            const questionResponse = "That's a great question. Let me have our staff call you back with the answer.";
...
function handleClarifyingState(
    ...
    if (intent === 'unclear' && context.clarificationAttempts >= context.maxClarificationAttempts) {
        ...
        return {
            newState: ConversationState.ESCALATING,
            responseText: "I want to make sure I understand you correctly. Let me have a staff member call you back.",
            shouldHangup: true,
            requiresHuman: true,
